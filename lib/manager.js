...
class Manager {
    ...
    inventory(type, order, item, transaction, resolve, reject) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield index_1.firestore.runTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                    return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                        const items = yield order.items.get(this._OrderItem, transaction);
                        for (const item of items) {
                            yield this.inventory(InventoryControlType.increase, order, item, transaction, resolve, reject);
                        }
    ...
    order(order, options, batch) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.inventoryControl(order, batch);
                return yield this.pay(order, options, batch);
            }
            catch (error) {
                throw error;
            }
                    ...
                    yield index_1.firestore.runTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                            try {
                                const items = yield order.items.get(this._OrderItem, transaction);
                                for (const item of items) {
                                    yield this.inventory(InventoryControlType.decrease, order, item, transaction, resolve, reject);
                                }
                                transaction.set(order.reference, {
                    ...
                    yield index_1.firestore.runTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                const newRevenueWithCurrency = revenueWithCurrency - amount;
                                const balance = account.balance || { accountsReceivable: {}, available: {} };
                                const accountsReceivable = balance.accountsReceivable;
                                const accountsReceivableWithCurrency = accountsReceivable[order.currency] || 0;
                                const newAccountsReceivable = accountsReceivableWithCurrency - net;
                                const result = yield this.delegate.cancel(order, options);
                                // set account data
                                transaction.set(account.reference, {
                                    updateAt: index_1.timestamp,
