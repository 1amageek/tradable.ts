...
class Manager {
                        ...
                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                            try {
                                ...
                                if (targetOrder.status === index_1.OrderStatus.paid ||
                                    ...
                                    targetOrder.status === index_1.OrderStatus.transferd ||
    ...
    refund(order, options, batch) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(order.status === index_1.OrderStatus.paid || order.status === index_1.OrderStatus.transferd || order.status === index_1.OrderStatus.waitingForTransferrd)) {
                    ...
                    yield index_1.firestore.runTransaction((transaction) => __awaiter(this, void 0, void 0, function* () {
                        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                            try {
                                const targetOrder = new this._Order(order.id, {});
                                yield targetOrder.fetch();
                                if (targetOrder.status === index_1.OrderStatus.transferd) {
