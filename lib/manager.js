...
class Manager {
    ...
    execute(order, process) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const batch = yield process(order, _batch);
                if (batch) {
                    yield batch.commit();
                }
            }
                            ...
                            switch (sku.inventory.type) {
                                case index_1.StockType.finite: {
                                    ...
                                    transaction.set(sku.reference, {
                                        updateAt: firestore_1.FieldValue.serverTimestamp(),
    ...
    refund(order, options, batch) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(order.status === index_1.OrderStatus.paid || order.status === index_1.OrderStatus.completed)) {
